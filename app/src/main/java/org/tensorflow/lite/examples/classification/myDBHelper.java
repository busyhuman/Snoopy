...
public class myDBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE foods (Num INTEGER NOT NULL PRIMARY KEY,FoodName VARCHAR(25) NOT NULL,Category VARCHAR(10) NOT NULL, ServingSize FLOAT NOT NULL,Kcal FLOAT NOT NULL,Carbo FLOAT NOT NULL,Protein FLOAT NOT NULL,Fat FLOAT NOT NULL,Natrium FLOAT NOT NULL );");

        class NewRunnable implements Runnable {
            @Override
            public void run() {
                str = SnoopyHttpConnection.makeConnection("https://busyhuman.pythonanywhere.com/foods/?format=json", "GET", null);
